...
public class SpexM750 extends Optic {
	...
	public double ccdCentrePos[] = { +separation, 0, axisHeight };
	...
	public double lens1DistFromCCD = -0.300;
	public double lens1Height = 0.080; 
	public double lens1FocalLength = -0.300;
	public double lens1CentreThickness = 0.010;
	public double lens1Length = 0.070;
	...
	public CylindricalPlanarConvexLens lens1 = CylindricalPlanarConvexLens.fromFocalLengthAndCentreThickness("lens1", 
			lens1Centre, outputAxis, globalUp, lens1Height/2, lens1FocalLength, 
			lens1CentreThickness, lens1Length, 
			lens1Medium, IsoIsoInterface.ideal(), designWavelenth);
			

	public double lens2DistFromCCD = -0.120;
	public double lens2Height = 0.080; 
	public double lens2FocalLength = 0.200;
	public double lens2CentreThickness = 0.010;
	public double lens2Length = 0.070;
	...
	public CylindricalPlanarConvexLens lens2 = CylindricalPlanarConvexLens.fromFocalLengthAndCentreThickness("lens2", 
			lens2Centre, outputAxis, globalUp, lens2Height/2, lens2FocalLength, 
			lens2CentreThickness, lens2Length, 
			lens2Medium, IsoIsoInterface.ideal(), designWavelenth);
			
	

	public double lens3DistFromCCD = -0.087;
	public double lens3Height = 0.080; 
	public double lens3FocalLength = 0.200;
	public double lens3CentreThickness = 0.010;
	public double lens3Length = 0.070;
	...
	public CylindricalPlanarConvexLens lens3 = CylindricalPlanarConvexLens.fromFocalLengthAndCentreThickness("lens3", 
			lens3Centre, outputAxis, globalUp, lens3Height/2, lens3FocalLength, 
			lens3CentreThickness, lens3Length, 
			lens3Medium, IsoIsoInterface.ideal(), designWavelenth);
