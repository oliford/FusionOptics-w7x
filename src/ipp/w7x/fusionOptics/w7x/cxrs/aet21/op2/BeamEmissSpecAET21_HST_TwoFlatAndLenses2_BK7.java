...
public class BeamEmissSpecAET21_HST_TwoFlatAndLenses2_BK7 extends Optic {
	...
	public double beamDumps[][] = {
			{ -0.217779, 4.57337, 0.488461 }, //S1, S5
			
			//{ 0.105223, 4.89688, 0.405341 }, //S2, S6
			{ 0.09220848846435548, 4.8905068359375, 0.404767578125 },	//S2, S6 Adjusted by Paul to avoid W		
			
			//{ 0.122839, 4.94578, 0.256883 }, //S3, S7
			{ 0.1048245620727539, 4.93611865234375, 0.2572196044921875 },	//S3, S7 Adjusted by Paul to avoid W
			
			{ -0.188638, 4.68283, 0.208365 } //S4, S8
