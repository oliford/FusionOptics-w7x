...
public class BeamEmissSpecAET21 extends Optic {
	...
	public Disc backPrismFront = new Disc("backPrismFront", backPrismFrontPos, shutterNormal, entryWindowDiameter/2, prismMedium, null, IsoIsoInterface.ideal());
	public Disc backPrismBack = new Disc("backPrismBack", backPrismBackPos, Util.mul(shutterNormal, -1.0), entryWindowDiameter*0.52, prismMedium, null, IsoIsoInterface.ideal());
	...
	public double mirrorWidth = 0.030;
	public double mirrorHeight = 0.050;
	
	public double mirrorCentreBackFromWindow = 0.035;	
	public double mirrorCentreAsideFromWindow = 0.035;
	...
	public double mirrorToPortAngle = 90 * Math.PI / 180;
	public double mirrorTipAngle = 10 * Math.PI / 180;
	
	public double mirrorUpZero[] = Util.reNorm(Util.cross(observationVec, portNormal));
		
	public double mirrorNormalA[] = Util.reNorm(Algorithms.rotateVector(Algorithms.rotationMatrix(mirrorUpZero, mirrorToPortAngle), portNormal));
	public double mirrorNormal[] = Util.reNorm(Algorithms.rotateVector(Algorithms.rotationMatrix(portNormal, mirrorTipAngle), mirrorNormalA));
	...
	public double mirror2TipAngle = 10 * Math.PI / 180;
	
	public double asideVector2[] = Util.reNorm(Algorithms.rotateVector(Algorithms.rotationMatrix(portNormal, 3.5*mirrorTipAngle), asideVector));
