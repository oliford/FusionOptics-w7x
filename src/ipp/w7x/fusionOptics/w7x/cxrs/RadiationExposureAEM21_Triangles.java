 ...
 *
 */
public class RadiationExposureAEM21_Triangles {
	
	//AEA21
	public static BeamEmissSpecAEM21_postDesign_LC3 sys = new BeamEmissSpecAEM21_postDesign_LC3(false);
	public static String inPath4 = "/work/cad/aem21/radExposure40/";
	
	public static Element[] testElements = {
			new STLMesh(inPath4 + "/FrontPlate.stl"),
			new STLMesh(inPath4 + "/Cup.stl"),
			new STLMesh(inPath4 + "/PortShield.stl"),
			new STLMesh(inPath4 + "/vessel.stl"),
			new STLMesh(inPath4 + "/Zwickel.stl"), 			
			new STLMesh(inPath4 + "/FrontPlatePipe.stl"),
			new STLMesh(inPath4 + "/PortShieldPipe.stl"),
			new STLMesh(inPath4 + "/MirrorClosed.stl"),
			new STLMesh(inPath4 + "/Cover1.stl"),
			new STLMesh(inPath4 + "/Cover2.stl"),
			new STLMesh(inPath4 + "/ProtectionCollar1.stl"),
			new STLMesh(inPath4 + "/ProtectionCollar2.stl"),
			new STLMesh(inPath4 + "/Tube.stl"),
			new STLMesh(inPath4 + "/MountArm.stl"),
			
			new STLMesh(inPath4 + "/portLiner-AEN21-spaltSchutz.stl"),
			new STLMesh(inPath4 + "/portLiner-AEN21-spaltSchutz2.stl"),

	};	
	
	public static Element[] thingsInWay = {	
			new STLMesh(inPath4 + "/panel1.stl"),
			new STLMesh(inPath4 + "/panel2.stl"),
			new STLMesh(inPath4 + "/panel3.stl"),

			new STLMesh(inPath4 + "/VesselSurround.stl"),
			new STLMesh(inPath4 + "/portLiner-AEN21-simple.stl"), 
...
/*
	...
	public final static String outPath = MinervaOpticsSettings.getAppsOutputPath() + "/rayTracing/cxrs/" + sys.getDesignName() + "/radExposure40-all5/";
